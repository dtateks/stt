...
- HUD/runtime semantics are encoded in `src/src/lib.rs`, `src/src/bar_window.rs`, `src/src/mic_shortcut.rs`, `src/src/commands.rs`, `ui/src/bar-session-controller.ts`, and `ui/src/soniox-client.ts`.
